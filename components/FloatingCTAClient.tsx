      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50">
        ...
        <div className="bg-white border-t border-slate-100 shadow-[0_-4px_20px_rgba(0,0,0,0.06)] px-4 pt-3 pb-safe">
          <div className="flex items-center gap-3 pb-3">
            ...
            >
              <Phone size={16} className="text-[#e53935]" />
              <span className="text-[#1a2d6b]">{phone}</span>
            </a>
      ...
      <div className="hidden md:flex fixed bottom-6 right-4 z-40 flex-col items-end gap-2">
        {expanded && (
          <div className="flex flex-col gap-2">
            <a href={phoneHref} className="flex items-center gap-2 bg-white border border-gray-200 text-gray-700 font-semibold text-sm px-4 py-2.5 rounded-full shadow-lg hover:shadow-xl transition-all whitespace-nowrap">
              <Phone size={15} className="text-[#e53935]" /> {phone}
            </a>
            <a href={lineHref} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-[#00c300] text-white font-semibold text-sm px-4 py-2.5 rounded-full shadow-lg hover:shadow-xl hover:bg-[#00a300] transition-all whitespace-nowrap">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                <path d="M8 0C3.582 0 0 3.13 0 6.993c0 3.492 3.1 6.407 7.286 6.926l-.288 1.073c-.049.183.118.35.3.3l3.3-1.07C13.2 13.2 16 10.3 16 6.993 16 3.13 12.418 0 8 0z" />
              </svg>
              LINE: {line}
