        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6 text-slate-500">
            {phones.slice(0, 2).map((p) => (
              <a key={p} href={`tel:${p.replace(/[^0-9]/g, '')}`} className="flex items-center gap-1.5 hover:text-[#e53935] transition-colors">
                <Phone size={12} className="text-[#e53935]" /> {p}
              </a>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href={`https://line.me/ti/p/~${line.startsWith('@') ? line : '@' + line}`}
                target="_blank"
