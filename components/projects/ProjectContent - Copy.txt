...
export default function ProjectContent({ project }: { project: any }) {
  // ==========================================
  // 📍 STATE สำหรับ GALLERY (รูปโครงการ)
  // ==========================================
  const [activeImg, setActiveImg] = useState(0);
  const [isGalleryFullscreen, setIsGalleryFullscreen] = useState(false);

  // ==========================================
  // 📍 STATE สำหรับ PLANS (แบบแปลน)
  // ==========================================
  ...
  // ==========================================
  // 📍 ระบบจัดการรูปพัง (Error Handling)
  // ==========================================
  ...
  return (
    <div className="bg-white">
      ...
      {/* =========================================
          📍 GALLERY SECTION (แบบดั้งเดิมของ user)
      ========================================= */}
      ...
      {/* =========================================
          📍 PLANS SECTION (ไม่มีกรอบครอบ โล่งโปร่งสบาย!)
      ========================================= */}
        ...
        <section id="plans" className="py-16 md:py-24 bg-slate-50 border-b border-slate-100">
          <div className="container mx-auto px-4 md:px-8">
            ...
            <div className="text-center mb-12">
              ...
              {/* สวิตช์สลับหมวดหมู่หลัก (Room Plans vs Floor Plans) */}
            ...
            <div className="max-w-6xl mx-auto">
              ...
              {/* --- 📍 พื้นที่โชว์รูปภาพที่เลือก (ไม่มีกรอบ คลิกได้) --- */}
              <div 
